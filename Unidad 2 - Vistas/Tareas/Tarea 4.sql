...
SELECT HosNombre, 
	   ENE = CASE WHEN (DATEPART(MM, Fecha) = 1)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   FEB = CASE WHEN (DATEPART(MM, Fecha) = 2)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   MAR = CASE WHEN (DATEPART(MM, Fecha) = 3)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   ABL = CASE WHEN (DATEPART(MM, Fecha) = 4)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   MAY = CASE WHEN (DATEPART(MM, Fecha) = 5)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   JUN = CASE WHEN (DATEPART(MM, Fecha) = 6)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   JUL = CASE WHEN (DATEPART(MM, Fecha) = 7)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   AGO = CASE WHEN (DATEPART(MM, Fecha) = 8)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   SEP = CASE WHEN (DATEPART(MM, Fecha) = 9)  THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   OCT = CASE WHEN (DATEPART(MM, Fecha) = 10) THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   NOV = CASE WHEN (DATEPART(MM, Fecha) = 11) THEN COUNT(DISTINCT Cita) ELSE 0 END,
	   DIC = CASE WHEN (DATEPART(MM, Fecha) = 12) THEN COUNT(DISTINCT Cita) ELSE 0 END
FROM VW_CITAS
WHERE YEAR(Fecha) = 2017
GROUP BY HosNombre,Fecha